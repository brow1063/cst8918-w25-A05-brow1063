...
resource "azurerm_linux_virtual_machine" "vm" {
  ...
  # Use an Ubuntu image from Canonical
  ...
  # Include your SSH public key for secure access
  admin_ssh_key {
  ...
  # Use the cloud-init config to run your initialization script on first boot
